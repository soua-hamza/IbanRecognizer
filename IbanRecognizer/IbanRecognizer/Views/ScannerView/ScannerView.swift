...
struct ScannerView: View {
    ...
    @State private var currentFrame: UIImage = .init()
    ...
    var body: some View {
        ...
        .onChange(of: scannerViewModel.currentFrame) { _, newValue in
        ...
        .onChange(of: scannerViewModel.recognizedIban) { _, newValue in
            if newValue != nil {
                isPresented = true
            }
        }
